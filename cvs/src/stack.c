...
static void do_push(List *stack, void *elem, int isstring){
	Node *p = getnode();
...
void push(List *stack, void *elem){
	do_push(stack, elem, 0);
}



void push_string(List *stack, char *elem){
	do_push(stack, elem, 1);
}



static void *do_pop(List *stack, int isstring){
	void *elem;
...
char *pop_string(List *stack){
	return do_pop(stack, 1);
}



static void do_unshift(List *stack, void *elem, int isstring){
	Node *p = getnode();
...
void unshift(List *stack, void *elem){
	do_unshift(stack, elem, 0);
}



void unshift_string(List *stack, char *elem){
	do_unshift(stack, elem, 1);
}



static void *do_shift(List *stack, int isstring){
	void *elem;
...
void *shift(List *stack){
	return do_shift(stack, 0);
}



char *shift_string(List *stack){
