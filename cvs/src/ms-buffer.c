...
static int ms_buffer_block(void *closure, bool block){
...
static int ms_buffer_input(void *closure, char *data, size_t need, size_t size,
                            size_t *got){
	struct ms_buffer *mb = closure;
	int status;
...
static int ms_buffer_get_fd(void *closure){
	struct ms_buffer *mb = closure;
...
static int ms_buffer_shutdown(struct buffer *buf){
