...
static int
internal_function FCT (const CHAR *pattern, const CHAR *string,
...
static const CHAR *
internal_function END (const CHAR *pattern) {
...
static int
internal_function EXT (INT opt, const CHAR *pattern, const CHAR *string,
                       const CHAR *string_end,
                       bool no_leading_period, int flags) {
	const CHAR *startp;
	size_t level;
