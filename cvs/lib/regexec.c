...
static regoff_t
internal_function re_search_stub (struct re_pattern_buffer *bufp,
                                  const char *string, Idx length,
...
static unsigned
internal_function re_copy_regs (struct re_registers *regs, regmatch_t *pmatch,
                                Idx nregs,
                                int regs_allocated) {
...
internal_function re_search_internal (const regex_t *preg,
                                      const char *string, Idx length,
                                      Idx start, Idx last_start, Idx stop,
                                      size_t nmatch, regmatch_t pmatch[],
                                      int eflags) {
...
static reg_errcode_t
internal_function prune_impossible_nodes (re_match_context_t *mctx) {
...
static Idx
internal_function check_matching (re_match_context_t *mctx,
                                  bool fl_longest_match,
                                  Idx *p_match_first) {
	re_dfa_t *const dfa = mctx->dfa;
	reg_errcode_t err;
...
static bool
internal_function check_halt_node_context (const re_dfa_t *dfa, Idx node,
        unsigned int context) {
...
static Idx
internal_function proceed_next_node (const re_match_context_t *mctx,
...
static reg_errcode_t
internal_function push_fail_stack (struct re_fail_stack_t *fs, Idx str_idx,
                                   Idx dest_node,
...
static Idx
internal_function pop_fail_stack (struct re_fail_stack_t *fs, Idx *pidx,
                                  Idx nregs, regmatch_t *regs, re_node_set *eps_via_nodes) {
	Idx num = --fs->num;
...
static reg_errcode_t
internal_function set_regs (const regex_t *preg, const re_match_context_t *mctx,
...
static void
internal_function update_regs (re_dfa_t *dfa, regmatch_t *pmatch,
                               regmatch_t *prev_idx_match,
...
static reg_errcode_t
internal_function sift_states_backward (re_match_context_t *mctx,
                                        re_sift_context_t *sctx) {
	reg_errcode_t err;
	int null_cnt = 0;
...
static reg_errcode_t
internal_function build_sifted_states (re_match_context_t *mctx,
                                       re_sift_context_t *sctx,
...
static reg_errcode_t
internal_function clean_state_log_if_needed (re_match_context_t *mctx,
...
static reg_errcode_t
internal_function merge_state_array (re_dfa_t *dfa, re_dfastate_t **dst,
                                     re_dfastate_t **src,
                                     Idx num) {
	Idx st_idx;
	reg_errcode_t err;
...
static reg_errcode_t
internal_function update_cur_sifted_state (re_match_context_t *mctx,
        re_sift_context_t *sctx,
...
static reg_errcode_t
internal_function add_epsilon_src_nodes (re_dfa_t *dfa, re_node_set *dest_nodes,
        const re_node_set *candidates) {
...
static reg_errcode_t
internal_function sub_epsilon_src_nodes (re_dfa_t *dfa, Idx node,
        re_node_set *dest_nodes,
        const re_node_set *candidates) {
	Idx ecl_idx;
	reg_errcode_t err;
...
static bool
internal_function check_dst_limits (const re_match_context_t *mctx,
                                    const re_node_set *limits,
...
static int
internal_function check_dst_limits_calc_pos_1 (const re_match_context_t *mctx,
        int boundaries,
...
static int
internal_function check_dst_limits_calc_pos (const re_match_context_t *mctx,
        Idx limit, Idx subexp_idx,
...
static reg_errcode_t
internal_function check_subexp_limits (re_dfa_t *dfa, re_node_set *dest_nodes,
...
static reg_errcode_t
internal_function sift_states_bkref (re_match_context_t *mctx,
                                     re_sift_context_t *sctx,
...
#ifdef RE_ENABLE_I18N
static int
internal_function sift_states_iter_mb (const re_match_context_t *mctx,
                                       re_sift_context_t *sctx,
...
internal_function transit_state (reg_errcode_t *err, re_match_context_t *mctx,
                                 re_dfastate_t *state) {
...
re_dfastate_t *
internal_function merge_state_with_log (reg_errcode_t *err,
                                        re_match_context_t *mctx,
...
static re_dfastate_t *
internal_function find_recover_state (reg_errcode_t *err,
                                      re_match_context_t *mctx) {
...
static reg_errcode_t
internal_function check_subexp_matching_top (re_match_context_t *mctx,
        re_node_set *cur_nodes,
        Idx str_idx) {
	re_dfa_t *const dfa = mctx->dfa;
	Idx node_idx;
...
#ifdef RE_ENABLE_I18N
static reg_errcode_t
internal_function transit_state_mb (re_match_context_t *mctx,
                                    re_dfastate_t *pstate) {
	re_dfa_t *const dfa = mctx->dfa;
	reg_errcode_t err;
	Idx i;
...
static reg_errcode_t
internal_function transit_state_bkref (re_match_context_t *mctx,
...
static reg_errcode_t
internal_function get_subexp (re_match_context_t *mctx, Idx bkref_node,
                              Idx bkref_str_idx) {
	re_dfa_t *const dfa = mctx->dfa;
...
static reg_errcode_t
internal_function get_subexp_sub (re_match_context_t *mctx,
                                  const re_sub_match_top_t *sub_top,
...
static Idx
internal_function find_subexp_node (const re_dfa_t *dfa,
                                    const re_node_set *nodes,
...
static reg_errcode_t
internal_function check_arrival (re_match_context_t *mctx, state_array_t *path,
...
static reg_errcode_t
internal_function check_arrival_add_next_nodes (re_match_context_t *mctx,
        Idx str_idx,
        re_node_set *cur_nodes,
        re_node_set *next_nodes) {
	re_dfa_t *const dfa = mctx->dfa;
...
static reg_errcode_t
internal_function check_arrival_expand_ecl (re_dfa_t *dfa,
        re_node_set *cur_nodes,
...
static reg_errcode_t
internal_function check_arrival_expand_ecl_sub (re_dfa_t *dfa,
        re_node_set *dst_nodes,
...
static reg_errcode_t
internal_function expand_bkref_cache (re_match_context_t *mctx,
                                      re_node_set *cur_nodes,
...
static bool
internal_function build_trtable (re_dfa_t *dfa, re_dfastate_t *state) {
	reg_errcode_t err;
	Idx i, j;
	int ch;
...
static Idx
internal_function group_nodes_into_DFAstates (const re_dfa_t *dfa,
        const re_dfastate_t *state,
...
static int
internal_function check_node_accept_bytes (re_dfa_t *dfa, Idx node_idx,
...
static bool
internal_function check_node_accept (const re_match_context_t *mctx,
...
static reg_errcode_t
internal_function extend_buffers (re_match_context_t *mctx) {
	reg_errcode_t ret;
...
static reg_errcode_t
internal_function match_ctx_init (re_match_context_t *mctx, int eflags, Idx n) {
	mctx->eflags = eflags;
...
static reg_errcode_t
internal_function match_ctx_add_entry (re_match_context_t *mctx, Idx node,
                                       Idx str_idx,
                                       Idx from, Idx to) {
...
static Idx
internal_function search_cur_bkref_entry (const re_match_context_t *mctx,
        Idx str_idx) {
...
static reg_errcode_t
internal_function match_ctx_add_subtop (re_match_context_t *mctx, Idx node,
                                        Idx str_idx) {
#ifdef DEBUG
...
internal_function match_ctx_add_sublast (re_sub_match_top_t *subtop, Idx node,
        Idx str_idx) {
...
static void
internal_function sift_ctx_init (re_sift_context_t *sctx,
