...
internal_function re_string_allocate (re_string_t *pstr, const char *str,
                                      Idx len, Idx init_len,
...
static reg_errcode_t
internal_function re_string_construct (re_string_t *pstr, const char *str,
                                       Idx len,
                                       REG_TRANSLATE_TYPE trans, bool icase, const re_dfa_t *dfa) {
	reg_errcode_t ret;
...
static reg_errcode_t
internal_function re_string_realloc_buffers (re_string_t *pstr,
        Idx new_buf_len) {
#ifdef RE_ENABLE_I18N
...
static void
internal_function re_string_construct_common (const char *str, Idx len,
        re_string_t *pstr,
        REG_TRANSLATE_TYPE trans, bool icase,
        const re_dfa_t *dfa) {
...
static Idx
internal_function re_string_skip_chars (re_string_t *pstr, Idx new_raw_idx,
                                        wint_t *last_wc) {
	mbstate_t prev_st;
	Idx rawbuf_idx;
	size_t mbclen;
...
static void
internal_function re_string_translate_buffer (re_string_t *pstr) {
	Idx buf_idx, end_idx;
	end_idx = (pstr->bufs_len > pstr->len) ? pstr->len : pstr->bufs_len;
...
static reg_errcode_t
internal_function re_string_reconstruct (re_string_t *pstr, Idx idx,
        int eflags) {
	Idx offset;
...
static unsigned int
internal_function re_string_context_at (const re_string_t *input, Idx idx,
                                        int eflags) {
	int c;
...
static reg_errcode_t
internal_function re_node_set_alloc (re_node_set *set, Idx size) {
	set->alloc = size;
	set->nelem = 0;
...
static reg_errcode_t
internal_function re_node_set_init_1 (re_node_set *set, Idx elem) {
	set->alloc = 1;
	set->nelem = 1;
...
static reg_errcode_t
internal_function re_node_set_init_2 (re_node_set *set, Idx elem1, Idx elem2) {
	set->alloc = 2;
...
static reg_errcode_t
internal_function re_node_set_init_copy (re_node_set *dest,
...
static reg_errcode_t
internal_function re_node_set_add_intersect (re_node_set *dest,
...
static reg_errcode_t
internal_function re_node_set_init_union (re_node_set *dest,
        const re_node_set *src1,
        const re_node_set *src2) {
	Idx i1, i2, id;
...
static reg_errcode_t
internal_function re_node_set_merge (re_node_set *dest,
                                     const re_node_set *src) {
...
static bool
internal_function re_node_set_insert (re_node_set *set, Idx elem) {
	Idx idx;
...
static bool
internal_function re_node_set_insert_last (re_node_set *set, Idx elem) {
	/* Realloc if we need.  */
	if (set->alloc == set->nelem) {
		Idx *new_elems;
...
internal_function calc_state_hash (const re_node_set *nodes,
                                   unsigned int context) {
...
internal_function re_acquire_state (reg_errcode_t *err, re_dfa_t *dfa,
                                    const re_node_set *nodes) {
	re_hashval_t hash;
...
static re_dfastate_t*
internal_function re_acquire_state_context (reg_errcode_t *err, re_dfa_t *dfa,
...
static reg_errcode_t
internal_function register_state (const re_dfa_t *dfa, re_dfastate_t *newstate,
                                  re_hashval_t hash) {
	struct re_state_table_entry *spot;
	reg_errcode_t err;
	Idx i;
...
static re_dfastate_t *
internal_function create_ci_newstate (const re_dfa_t *dfa,
                                      const re_node_set *nodes,
                                      re_hashval_t hash) {
	Idx i;
	reg_errcode_t err;
...
static re_dfastate_t *
internal_function create_cd_newstate (const re_dfa_t *dfa,
                                      const re_node_set *nodes,
...
static void
internal_function free_state (re_dfastate_t *state) {
